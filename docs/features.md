...
| --- | --- | --- | --- |
| `replace_rating(text)` | Detects `5/5`, star emojis, verbal scores (“lima bintang”) and converts them into numeric auto scales into 0–5 range. | – | `resources/regex_patterns/rating_patterns.json`, `rating_rules.json`. |
